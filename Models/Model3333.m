...
Vars{1} = 'LL';          IVs(1) = 1;                Var_unit(1) = "u"; % 'L', 1, any of the following ["p", "n", "u", "m", "", "K", "M", "G", "T"]
Vars{2} = 'RR';           IVs(2) = 1;                Var_unit(2) = "u";
Vars{3} = 'LL_RR';        IVs(3) = 0;                Var_unit(3) = "u";
Vars{4} = 'RR_LL_RR';       IVs(4) = 0;                Var_unit(4) = "u";
...
eqns{1} = {["LL", "RR"], "LL_RR", 1}; % {["R", "LL_R"], "LL_RR", 2}
eqns{2} = {["LL_RR", "RR"], "RR_LL_RR", 2}; % {["R", "LL_R"], "LL_RR", 2}
