...
Vars{1} = 'L';          IVs(1) = 1000;             Var_unit(1) = ""; % 'L', 1, any of the following ["p", "n", "u", "m", "", "K", "M", "G", "T"]
Vars{2} = 'R';         IVs(2) = 1;              Var_unit(2) = "";
...
% to zero
K = zeros(1, 2);
K_unit = ""; % any of the following ["p", "n", "u", "m", "", "K", "M", "G", "T"]
T_unit = "";
