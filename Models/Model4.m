...
Vars{1} = 'R0';          IVs(1) = 100;   Var_unit(1) = ""; % 'L', 1, any of the following ["y", "z", "a", "f", "p", "n", "u", "m", "", "K", "M", "G", "T", "P", "E", "Z", "Y"]
Vars{2} = 'R1';          IVs(2) = 0;    Var_unit(2) = "";
...
%                 Eqn number            Var
catalysts{1}(1) = 2; catalysts{2}{1} = 2; % 1, "LL"
